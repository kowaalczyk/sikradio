...
namespace sikradio::sender {
    ...
    public:
        ...
        optional<sikradio::common::ctrl_msg> receive() {
            ...
            return optional<sikradio::common::ctrl_msg>(sikradio::common::ctrl_msg(str_buffer, client_address));
        }

        void respond(const sikradio::common::ctrl_msg &request, const char *response, size_t response_len) {
        ...
        void respond_force(const sikradio::common::ctrl_msg &request, const char *response, size_t response_len) {
            while (true) {
                try {
